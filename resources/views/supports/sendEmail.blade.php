                  ...
                  <form class="form-horizontal" id="myform">
                      <input type='hidden' id="email" value="{{$email}}" name="email"/>
                       <div class="ibox-content">
                               <div>发送邮箱：@if(!empty($email)) {{$email}}@endif</div>
                       </div>
                        <div class="ibox-content">
                            <div>标题： <input class="form-control" id="emailTitle"
                                style="display: inline-block;width: 80%;"/></div>
                        </div>
                     <div class="ibox-content" style='height: 147px'>
                         <div class="inline" style='vertical-align: middle;height: 90%;'>内容：</div>
                         <div style='padding: 0px' class="inline">
                                <textarea id="emailMsg" style="height: 100px;width:602px;" resize="none" name="emailMsg" maxlength="200"></textarea>
                             </div>
                        </div>
           ...
           <!--TOKEN验证-->
            ...
            $("#sure_send").click(function(){
               ...
               $.ajax({
                    ...
                    dataType:'json',
                    url:"/wo/postEmail",
                    data:{'emailTitle':emailTitle,'msg':msg,'email':email },
