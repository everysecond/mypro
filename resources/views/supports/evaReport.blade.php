        ...
        <div class="col-sm-12">
            <div class="ibox">
                <div class="report-list-title">
                    　◆ 工单管理　>　工单业务统计表
                    &nbsp;&nbsp;&nbsp;<a style="text-decoration: underline" href="evaReport">工单处理满意度</a>
                ...
                <div class="report-list-content">
                    ...
                    <button class="submit-btn" id="report1">生成统计报表</button>
                </div>
            </div>
            <div style="margin-top: 5px;">
                <div class="tab-content" style="padding: 5px 5px 5px 5px;background-color: white">
                    <div class="supTable" id="supT1" value="supT1">
                        ...
                        <div style="padding: 10px;border-top: 4px solid rgba(74, 74, 74, 0.18);">
                            ...
                            <br>
                            <span style="color:gray;font-size:10px; border-left-width: 120px; margin-left: 60px;">评价工单数量和工单总数都是指按条件（工单负责人群组，工单优先级等）过滤后得到的数量.</span>
                            <br>
                            <span style="color:gray;font-size:10px; border-left-width: 120px; margin-left: 60px;">满意度 =（工单总数-不满意工单数）/工单总数× 100 %.</span>
                            <br>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function doNewSearch(data, values) {
        $('#evaTable').bootstrapTable('refresh', {
            query: {
                'year': $('#year').val(),
                'charge': $('#charge').val(),
