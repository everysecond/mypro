            ...
            <div class="float-e-margins">
                <div class="ibox-content">
                                                ...
                                                <span class="m-b-none form-inline">
                                                    <select class="form-control" value="" name="supportType"
                                                        ...
                                                        @foreach($typeList as $type)
                                                            <option value="{{$type->Code}}">{{$type->Means}}</option>
                                                        @endforeach
                                                    </select>
                                                </span>
                                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div>
                                        ...
                                        <textarea class="validate" value="" name="content"
                                                  style="width: 85%;height: 150px;margin-bottom: -135px;resize: none;"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="text-right">
                        ...
                        <input type="button" class="btn btn-primary" id="distribute" value="提交">
