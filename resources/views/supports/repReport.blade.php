        ...
        <div class="col-sm-12">
            <div class="ibox">
                <div class="report-list-title">
                    ...
                    &nbsp;&nbsp;&nbsp;<a href="comReport">工单完成超时比率</a>
                    &nbsp;&nbsp;&nbsp;<a style="text-decoration: underline" href="repReport">工单响应超时比率</a>
                ...
                <div class="tab-content" style="padding: 5px 5px 5px 5px;background-color: white">
                    <div class="supTable" id="supT3">
                        ...
                        <div style="padding: 10px;border-top: 4px solid rgba(74, 74, 74, 0.18);">
                            ...
                            <br>
                            <span style="color:gray;font-size:10px; border-left-width: 120px; margin-left: 60px;">响应超时工单数量和工单总数都是指按条件（工单负责人群组，工单优先级等）过滤后得到的数量.</span>
                            <br>
                            <span style="color:gray;font-size:10px; border-left-width: 120px; margin-left: 60px;">超时响应条件是指超过2分钟.</span>
                            <br>
                            <span style="color:gray;font-size:10px; border-left-width: 120px; margin-left: 60px;">响应超时率 = 超时响应的工单数量/工单总数 × 100 %.</span>
                            <br>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function doNewSearch(data, values) {
        $('#repTable').bootstrapTable('refresh', {
            query: {
                'year': $('#year').val(),
                'charge': $('#charge').val(),
