        ...
        <div class="col-sm-12">
            <div class="ibox">
                <div class="report-list-title">
                    ...
                    &nbsp;&nbsp;&nbsp;<a style="text-decoration: underline" href="sucReport">工单成功解决率</a>
                ...
                <div class="report-list-content">
                    ...
                    <button class="submit-btn" id="report4">生成统计报表</button>
                </div>
            </div>
                ...
                <div class="tab-content" style="padding: 5px 5px 5px 5px;background-color: white">
                    <div class="supTable" id="supT2">
                        ...
                        <div style="padding: 10px;border-top: 4px solid rgba(74, 74, 74, 0.18);">
                            ...
                            <br>
                            <span style="color:gray;font-size:10px; border-left-width: 120px; margin-left: 60px;">群组工单数量都是指按条件（工单优先级等）过滤后得到的数量.</span>
                            <br>
                            <span style="color:gray;font-size:10px; border-left-width: 120px; margin-left: 60px;">工单总数是指按条件（不过滤工单负责人群组）过滤后得到的数量.</span>
                            <br>
                            <span style="color:gray;font-size:10px; border-left-width: 120px; margin-left: 60px;">XX群组工单成功解决率 = XX负责人群组完成的工单数量 /工单总数 × 100 %.</span>
                            <br>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function doNewSearch(data, values) {
        $('#sucTable').bootstrapTable('refresh', {
            query: {
                'year': $('#year').val(),
                'charge': $('#charge').val(),
