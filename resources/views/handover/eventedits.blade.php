        ...
        <div class="ibox float-e-margins">
            <div id="mC1Q5" class="print_main">
                <div class="print_content" style="margin-top: -6px;border:0px;">
                    <form id="eventform" enctype="multipart/form-data" style="width: 900px">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="hiddenDiv" id="dcHidden">
                                            <select name="dcGroup" id="dcGroup"
                                                    onchange="getDCStuffs(this)"
                                    ...
                                    <td colspan="3">
                                        <div style="display: inline-block">
                                            <input type="hidden" value="" name="charger" id="charger">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <input class="form-control" type="text" readonly="readonly"
                                               ...
                                               id="selectId" value="" name="csNames" style="width: 594px;
                                        ...
                                        <div >
                                            <input type="hidden" value="" name="chargerTwo" id="chargerTwo">
                                            <select class="form-control" multiple=""
                                                    style="display: inline-block;margin-left:10px;width: 50%" name="cuids"id="cuids">
                                            </select>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <textarea class="form-control validate" id="notes"
                                                  name="notes" style="margin-left: 10px;width: 650px;
...
<script>
    $('#chargerId').change(function(){
        $('#charger').val($(this).find("option:selected").text());
    })
    ...
    $("#removeusers").click(function () {
        var roption = $("[name='cuids'] option:selected"), csIds = "",csNames = "";
        if (roption.length > 0) {
    ...
    $('.btnSub').click(function () {
        ...
        if (!validateMark) {
            var data=$('#eventform').serializeArray(),formData={};
            //将数据转化成符合要求的格式
            for(var i in data){
            ...
            parent.$('#relatedEventsTable').bootstrapTable('updateRow',{index:$('#index').val(),row:formData});
            layer.msg('事件已编辑成功！', {icon: 1, time: 2000},function(){closeFrame()});
        }
    });
</script>
