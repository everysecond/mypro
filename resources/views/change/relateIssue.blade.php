...
<head>
    ...
    <![endif]-->
    <link href="/css/usercenter.css?1" rel="stylesheet" type="text/css">
    ...
    <div class="col-sm-6 relateIssue">
        <div class="" style="margin-top: 3px;border:0px;width:760px">
            ...
            <table id="devTable" class="table-no-bordered active"
                   ...
                   data-url="/change/getRelateIssue"
    ...
    $('.batchRelate').click(function () {
        ...
        layer.confirm('确定要批量关联问题吗?', {
                ...
                function () {
                    ...
                    $.ajax({
                        type: "POST",
                        data: {'issueIds': selected,'changeId': parent.$('#changeId').val(),
                            'triggerId': parent.$('#changeId').val()},
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
                        url: "/correlation/batchChangeIssue",
                        success: function (data) {
                            if (data.status == 'ok') {
