            ...
            columns: [
                [{
                    ...
                    formatter: function (value, row, index) {
                        var s = '<a class="showIssueTips J_menuItem" style="display: inline-block; min-width: 130px"  id="issueNo_' + row.Id + '"    ' +
                    ...
                    align: 'left',
                    formatter: function (value, row, index) {
                        if (row.issueState == 'reject') {
                            var s = '<a class="showIssueTips J_menuItem" menuName="' + row.Id + '"  id="title_' + row.Id + '"    ' +
                                    'href="/Issue/saveToapply/' + row.Id + '">' + '</a>';
                        }
                        else {
                            var s = '<a class="showIssueTips J_menuItem" menuName="' + row.Id + '"  id="title_' + row.Id + '"    ' +
                    ...
                    '<ul class="select-list"><li class="select-list-item" value="">问题来源</li>@foreach($sourceList as $source) <li class="select-list-item" value="{{$source->Code}}">{{$source->Means}}</li>@endforeach</ul></div>',
                    valign: 'middle',
                    align: 'left',
                }, {
                    field: 'issuePriority',
