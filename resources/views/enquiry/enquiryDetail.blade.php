                ...
                <table class="table-edit" style="color: #000000;" bgcolor="#FFFFFF" border="1" width="100%">
                    ...
                    <tr>
                        ...
                        <td colspan="3" width="40%">
                            <div style="max-width: 80%;word-break: break-all" class="divBack">
                ...
                [
                    ...
                    },
                    {
                        ...
                        formatter:function(value, row, index){
                            ...
                            return row.unitPrice+costPrice;
                        }
                    },
                    {
                        field: 'userId',
                    ...
                    },
                    {
                        ...
                        formatter: function (value, row, index) {
                            return "<button class='btn btn-xsm btn-outline btn-primary'" +
                                    " onclick='offerDetail(" + row.id + ")'>查看详情</button>";
                        }
                    }
                ]
            ],
            ...
            columns: [
                [
                    ...
                    },
                    {
                        ...
                        align: 'left',
                        formatter: function (value, row, index) {
                            return "<span>" + row.recordType + "</span>";
                        },
                        events: 'operateEvents'
                    },
                    {
