                        ...
                        <div class="full-height-scroll">
                            <div class="table-responsive" style="background-color: white">
                                <table id="salesTable" class="table-no-bordered table-fixpadding"
                                       ...
                                       data-url="/enquiry/getAllList?role={{$role}}"
            ...
            columns: [
                [
                    ...
                    },
                    {
                        ...
                        align: 'left',
                        formatter: function (value, row, index) {
                            return (row.isEdit && row.steps !="询价完成" &&row.steps !="销售申请") ?
                            "<a class='J_menuItem' menuname='/enquiry/productOffer/" + row.id + "'" +
                            "href='/enquiry/productOffer/" + row.id + "' >" +
                            "<i class='fa fa-edit'></i> " + row.enquiryNo + "</a>" :
                            "<a class='J_menuItem' menuname='/enquiry/productOffer/" + row.id + "'" +
                            "href='/enquiry/enquiryDetail/" + row.id + "' >" +
