            ...
            <div id="mC1Q5" class="print_main">
                <div class="print_content" style="margin-top: -6px;border:0px;">
                    <form action="{{url('rpms/resourceProd/newProdSub')}}" method="POST" id="newContact"
                          enctype="multipart/form-data" style="width: 560px">
                        <fieldset>
                            {{csrf_field()}}
                            <table class="table-edit" style="color: #000000;" bgcolor="#FFFFFF" border="1"
                                   cellpadding="0" cellspacing="0" width="520px">
                                <tbody>
                                <tr>
                                    <td colspan="2">
                                        <div style="float:left;height: 2px;font-weight: 700;">
                                            <input type="hidden" name="contactId" disabled="disabled"
                                                   value="@if($contact!="" && $contact->id){{$contact->id}}@endif">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="30%"><span style="color: red">*</span>姓名：</td>
                                    <td width="25%">
                                        <input type="text" class="form-control validate ml3" id="name"
                                               name="name" placeholder="联系人姓名" disabled="disabled"
                                    ...
                                    <td width="35%">
                                        <select name="type" id="type" disabled="disabled"
                                                class="form-control validate ml3" style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control validate ml3" id="mobile"
                                               name="mobile" disabled="disabled"
                                               value="@if($contact!="" && $contact->mobile){{$contact->mobile}}@endif"
                                               style="width: 100%;"/>
                                    </td>
                                    <td align="right">联系电话：</td>
                                    <td>
                                        <input type="text" class="form-control validate ml3" id="tell"
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <input type="email" class="form-control ml3" id="email"
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <div style="height: 64px;width:100%;" class="ml3">
                                ...
                                <tr>
                                    <td colspan="3"></td>
                                    <td>
                                        <a type="reset" class="btn btndefault ml9" onclick="closeFrame()"
